...
```{r}
write.csv(test.ssn,"data/ICPRB2/test_ssn.csv")
```
...
```{r}
jpeg("data/ICPRB2/torgegram_flow_connected.jpg")
plot.Torgegram(test_torg, sp.relationship = c("fc"), xlab = "Stream Distance (meter)")
dev.off()

jpeg("data/ICPRB2/torgegram_flow_unconnected.jpg")
...
write.csv(esttable,"data/ICPRB2/test_aspatialestimates.csv")
...
# write.csv(test_master,"data/ICPRB2/test_master.csv")

testmaster <- getSSNdata.frame(test_master, "preds") 
write.csv(testmaster,"data/ICPRB2/testmaster.csv")
```
...
jpeg("data/ICPRB2/model_torgegram_full.jpg")
plot(test_1t, main= "Model1 Residuals Torgegram") 
dev.off()

jpeg("data/ICPRB2/model_1_flow_connected.jpg")
plot.Torgegram(test_1t, sp.relationship = c("fc"), xlab = "Stream Distance (meter)")
dev.off()

jpeg("data/ICPRB2/model_1_flow_unconnected.jpg")
...
write.csv(esttable,"data/ICPRB2/model_1_estimates.csv")
...
write.csv(pred1df,"data/ICPRB2/model_1_predictions.csv",row.names=F)
write.dbf(pred1df,"data/ICPRB2/model_1_predictions.dbf")
...
# write.csv(predobs,"data/ICPRB2/model_1_prediction_observations.csv",row.names=F)
